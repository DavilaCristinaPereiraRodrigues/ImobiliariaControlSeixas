...
public class ControlSeixas {
	...
	public static void main(String[] args) {
		...
		do { // início de um laço, do...while
			...
			case EFETUARLOGIN:// chamando o método efetuarLogin
				cs.efetuarLogin();
				break;

			case INCLUIRFIADOR:// chamando o método incluirFiador
				cs.incluirFiador();
				break;
...
*/
	...
	public void incluirFiador() {
		...
		// id_fiador = Teclado.lerInt("código" ); //coloquei e não perguntei
		// ao usuário
		...
		// O id é auto_increment perguntar como ñ perguntar para o usuário
		// int id_endereco = Teclado.lerInt("Id endereço");

		// Só perguntei o cep pois irá perguntar o Cep e virar o logradouro,
		// bairro, cidade e bairro
		String cep = Teclado.lerTexto("CEP:");

		// Joga as informações primeiro no Endereço
	...
	public void alterarFiador() {
		...
		// Joga as informações primeiro no Endereço depois alterado
		enderecos = EnderecoDAO.buscarEndereco(cep);

		// Joga as informações depois no fiador alterado
	...
	public void buscarAluguel() {
		...
		int num_contAluguel = Teclado.lerInt("Número do Contrato ");
	...
	public void incluirCliente() {
		...
		// Puxando as informações para o Banco de Dados
	...
	public void alterarCliente() {
		...
		// Joga as informações depois no Cliente
	...
	// Primeiro tem que vir o cadastro do Proprietário e após do imóvel
	public void incluirImovel() {
		System.out.println("====================");
		System.out.println("|    Incluir Imóvel |");
		System.out.println("====================\n");

		int codigo = Teclado.lerInt("Código do Imóvel: "); // NÃO É A ID
		String tp_negocio = Teclado
				.lerTexto("Negócio (0 - locação, 1 - venda)");
		String tp_pos = Teclado
				.lerTexto("Posição: (0 -  frentes , 1 - fundos)");
		...
		String area_total = Teclado.lerTexto("Área total em m²: ");
		String area_cons = Teclado.lerTexto("Área construída em m²: ");
		String area_util = Teclado.lerTexto("Área útil em m²: ");
		String qtd_comodos = Teclado.lerTexto("Quantidade de cômodos: ");
		...
		// Proprietário
		String cpf_prop = Teclado.lerTexto("Cpf do proprietário: ");
	...
	public void excluirImovel() {
		...
		int codigo = Teclado
				.lerInt("Digite o código do Imóvel que deseja excluir");
	...
	public void alterarImovel() {
		...
		int id_imovel = Teclado.lerInt("Digite o código do negócio : ");

		int codigo = Teclado.lerInt("Código");
		String tp_negocio = Teclado
				.lerTexto("Negócio (0 - locação, 1 - venda)");
		String tp_pos = Teclado
				.lerTexto("Posição: (0 -  frentes , 1 - fundos)");
		...
		// Alteraçao do Endereço
		System.out.println("Endereço \n");
		String cep = Teclado.lerTexto("CEP:");

		// Alteraçao do Proprietário
	...
	// Primeiro Inclui o Proprietário e após o Imóvel
	public void incluirProprietario() {
		...
		String estado_civil = Teclado.lerTexto("Estado-Civil: ");
		String profissao = Teclado.lerTexto("Profissão: ");
		String complemento = Teclado.lerTexto("Complemento: ");
	...
	public void excluirProprietario() {
		...
		String cpf_prop = Teclado
				.lerTexto("Digite o cpf do Proprietário a ser excluido: ");
	...
	}// fim do alterarProprietário

	public void incluirCompra() {

		System.out.println("NOVO - Contratos de Compra ");

		int num_contCompra = Teclado.lerInt("Número do Contrato ");
		String dt_aquisicao = Teclado.lerTexto("Data de Aquisição ");
		double valor = Teclado.lerDouble("Valor ");
		String tp_pag = Teclado.lerTexto("Tipo de Pagamento ");
		int n_parcela = Teclado.lerInt("Número de Parcelas ");
		double comissao_cor = Teclado.lerDouble("Valor da Comissão ");
		...
		int codigo = Teclado.lerInt("Código do Imóvel ");
		...
		for (Fiador fiador : fiadores) {
			...
			// Joga as informações primeiro no Fiador

		fiadores = FiadorDAO.buscarFiador(cpf_fiador);

		// array list do proprietário
		System.out.println("Dados do Proprietário");

		String cpf_prop = Teclado.lerTexto("Cpf do Proprietário");

		// List do Proprietário
	...
	public void excluirCompra() {
		...
		int num_contCompra = Teclado
				.lerInt("Digite Número do Contrato que deseja excluir \n");
	...
	public void incluirAluguel() {
		...
		String dt_pag = Teclado.lerTexto("Pagar até o dia ");
		double valor = Teclado.lerDouble("Valor do Aluguel R$ ");
		double comissao_cor = Teclado
				.lerDouble("Valor da Comissão do Corretor R$ ");
		...
		imovel = ImovelDAO.buscarImovelCodigo(codigo); // Só para buscar o
														// código
	...
	public void excluirAluguel() {
		...
		int num_contAluguel = Teclado
				.lerInt("Número do Contrato que deseja excluir: ");
...
/*/
	...
	public void buscarProp() {
		...
		System.out.println("Buscar Proprietário \n");
	...
	public void PesquisarImovel() { //TELA DE PESQUISAR IMÓVEL
