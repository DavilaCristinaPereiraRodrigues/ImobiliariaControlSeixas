	...
	public JanelaImovel() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				model.Imovel	imovel = ImovelDAO.buscarImovelCodigo(codigo);
					//saber se já possui um codigo cadastrado igual na tabela imovel
		...
		btnExcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				case JOptionPane.YES_OPTION:
					// Se clicar em Sim exclui o Imóvel
					  for (int i=0; i < getContentPane().getComponentCount(); i++) {  
		                    //varre todos os componentes  
		...
		btnPesquisarProp.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				// Verificar se o Imóvel existe no Banco de Dados e vem com
				// os dados completo do Imóvel id, nome, telefone
				if (proprietario == null) {
					...
					/*
					 * JOptionPane.showMessageDialog(null,
					 * "Dados do Imóvel \n " + Imóvel);//está pegando //o
					 * método toString no model Imóvel e jogando neste
					 * showMessage
					 */
		...
		btnPesqImovel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (imovelmd != null) {
					...
					//conversão para padrão de data brasileiro dd/mm/aaaa
				...
				} else { // se não estiver cadastrado um cpf no Imóvel amostra
							// o JoptionPANE
