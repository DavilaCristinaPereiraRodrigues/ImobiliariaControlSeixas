...
public class PesquisarImovel extends JFrame {
	...
	public PesquisarImovel() {
		...
		tabela.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if(arg0.getButton()==MouseEvent.BUTTON1){
					...
					JanelaImovel janelaImovel = new JanelaImovel();
					janelaImovel.setar(codigo);
					dispose();
		...
		JPanel painelDaTabela = new JPanel();
		 ...
		 tabela.setPreferredScrollableViewportSize(new Dimension(770, 210));  
		...
		scrollPane.setLocation(10, 350);  
		scrollPane.setSize( 774, 215);  
		//getContentPane().add(scrollPane);
		painelDaTabela.add(scrollPane);
		painelDaTabela.setBounds(10, 350, 774, 215);
		...
		btnPesquisar.setBounds(353, 308, 134, 31);
